function [success_weighted_path_length, success_ct, mean_val, std_val] = GreedyFunc(source_dir, source_fname, target_dir, no_of_simulations,...
...
target_f_name = sprintf("Greedy-Neg-%s-SPL-BinThresh-%d-DistThresh-%.2f-IntermPtsCt-%d.mat",...
