function [step_counter, successes] = GreedyGPU(g, source_dir, source_fname, target_dir, no_of_simulations,...
                ...
                while m <= index_len
                    if ~registered_good(indices(m))
                        ...
                        if dist_to_objects(indices(m)) < prob_detect
                            ...
                            newWP = recalculateGreedyGPU(g, seenPts,pt_count_threshold_bin, ang_bins, max_r);
