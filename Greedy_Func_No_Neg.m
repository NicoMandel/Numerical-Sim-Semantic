function [success_weighted_path_length, success_ct, mean_val, std_val] = Greedy_Func_No_Neg(source_dir, source_fname, target_dir, no_of_simulations,...
...
%     fprintf('Finished Processing file %d for Greedy\n',q);
end
if rand_recalc
    rand_str ="rand_recalc";
else
    rand_str ="no_rand"';
end
target_f_name = sprintf("Greedy-NoNeg-%s-SPL-BinThresh-%d-DistThresh-%.2f-IntermPtsCt-%d.mat",...
