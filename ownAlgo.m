function [success_weighted_path_length, success_ct, mean_val, std_val] = ownAlgo(source_dir, source_fname, target_dir, no_of_simulations,...
...
%     rand_obj = var.rand_obj;
    ...
    while ~target_found && k < wps_len
        ...
        while l <= interim_ct && ~recalculated
            ...
            if ~recalculated && steps_since_recalc > intermediate_pts_ct
...
target_f_name = sprintf("Own-Neg-%s-SPL-BinThresh-%d-DistThresh-%.2f-IntermPtsCt-%d.mat",...
