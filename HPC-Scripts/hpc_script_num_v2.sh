			...
			do
				...
				do
					...
					then	
						...
						echo ${header_3} >> ${this_script_file}
						echo ${header_4} >> ${this_script_file}
						echo "#PBS -N NM_${i}_${j}_${k}_${p}_${q}" >> ${this_script_file}
						
						echo ${body_1} >> ${this_script_file}
						echo ${body_2} >> ${this_script_file}
						
						# Will this get hung up by using /r instead of -r ?
						echo "matlab -nodisplay -r 'bigfunction(${i}, ${j}, ${k}, ${p}, ${q}, 0)' quit" >> ${this_script_file}
						qsub ${this_script_file}
						mv ${this_script_file} script_files/
					fi
				done
